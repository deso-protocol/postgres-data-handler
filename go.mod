...
exclude google.golang.org/grpc/stats/opentelemetry v0.0.0-20241017163036-56df169480cd

replace google.golang.org/grpc/stats/opentelemetry => google.golang.org/grpc v1.72.0
